...
/**
 * Created by hxpeng on 2016/8/11.
 */
public class EhcacheUtils {
    ...
    static {
        String path = EhcacheUtils.class.getClassLoader().getResource("config/ehcache.xml").getPath();
        EhcacheUtils.initCacheManager(path);
     ...
     * @param eternal             缓存中对象是否为永久的，如果是，超时设置将被忽略，对象从不过期。
    ...
    public static Cache initCache(String cacheName, long timeToLiveSeconds) throws Exception {
        return EhcacheUtils.initCache(cacheName, MAXELEMENTSINMEMORY, OVERFLOWTODISK,
